    ...
    func addConstrints(postion: AnimatePosition, message: AnimatedViewMessage, controller: UIViewController) {
        ...
        switch message {
            ...
            case let .message(text):
                ...
                switch postion {
                    case .top:
                        self.topAnchor.constraint(equalTo: rootView.safeAreaLayoutGuide.topAnchor, constant: controller.navigationController?.isNavigationBarHidden == true ? 20: 44).isActive = true
                    case .bottom:
